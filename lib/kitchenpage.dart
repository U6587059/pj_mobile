...
class KitchenRoom extends StatefulWidget {
  @override
  _KitchenRoomState createState() => _KitchenRoomState();
}

class _KitchenRoomState extends State<KitchenRoom> {
  String _roomName = 'KITCHEN ROOM';
  String _startTime = '09:00';
  String _endTime = '09:30';
  DateTime _selectedDate = DateTime.now();
  TextEditingController _roomController = TextEditingController(text: 'KITCHEN ROOM');
